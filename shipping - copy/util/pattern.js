...
export const ossLocation = {
    ...
    vehicle: {
         ...
         * 行驶证主页
         */
        first: "vehicle-license_photo_first-",

        /**
         * 行驶证副页
         */
        second: "vehicle-license_photo_second-",

        /**
         * 道路运输证
         */
        road: "vehicle-roadcert_photo-",
        /**
         * 人车
         *
         */
        rc: "vehicle-people_vehicle_photo-",
        /**
         *  车辆租赁合同
         */
        rent:"vehicle-rent_agreement-"
    },
    trailer: {
      /**
       * 挂车行驶证主页
       */
      first: "trailer-license_photo_first-",
    ...
    driver: {
         ...
         * 从业资格证
         */
        cert: "driver-qualification_cert_no-",

        /**
         * 身份证正面
         */
        front: "driver-idcard_front-",

        /**
        * 身份证背面
        */
        reverse: "driver-idcard_back-",

        /**
         * 驾驶证主页
         */
        first: "driver-license_photo_first-",

        /**
         * 驾驶证副页
         */
        second: "driver-license_photo_second-",
      /**
       * 聘用合同
       */
        rent: "driver-rent_agreement-"
    },
