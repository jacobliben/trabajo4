	...
	<view>
		<form @submit="formSubmit" >
				<view class="cu-form-group" v-if="hidePass">
					<text class="title">旧密码</text><text class="red">*</text>
				...
				<view class="cu-form-group" v-if="hidePassNew">
					<text class="title">新密码</text><text class="red">*</text>
					
					<input type="text"  placeholder="请输入新密码" maxlength="16" :value= "contrasena"
					 name="mobile" password   @blur="enterNewPassword">
					 <text class="cuIcon-attentionforbid text-gray" @click="hidePassNew=!hidePassNew"></text>
				...
				<view class="cu-form-group" v-if="!hidePassNew">
					...
					<input type="text"  placeholder="请输入新密码" maxlength="16" :value= "contrasena"
					 ...
					 <text class="cuIcon-attention text-gray " @click="hidePassNew=!hidePassNew"></text>
					 
				</view>
				
				<view class="cu-form-group"  v-if="hidePassRepeat">
					<text class="title">重复密码</text><text class="red">*</text>
