	...
	<view>
	    <view class="head-sect">
	    		  ...
	    		  <view class="tabbar">
	    		  		  ...
	    		  		  class="tab-item" :class="{current: 0 === index }" 
	    		  		  @click ="tabClick(index)" scroll-x="true"  scroll-left="120">
						     
								
									 <image :src=" item.srcSelected" v-if ="0 === index" mode="aspectFit" class="tab-img" ></image>
								     <image :src=" item.src" v-if ="0 != index" mode="aspectFit" class="tab-img" ></image>
								 	<text >{{item.text}}</text>								 
