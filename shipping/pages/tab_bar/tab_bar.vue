	    ...
	    <view class="head-sect">
			{{tabCurrentIndex}}
	    		  <view class="tabbar">
	    		  		  ...
	    		  		  class="tab-item" :class="{current: tabCurrentIndex === index }" 
	    		  		  @click ="tabClick(index)" scroll-x="true"  scroll-left="120">
						     
								
									 <image :src=" item.srcSelected" v-if ="tabCurrentIndex === index" mode="aspectFit" class="tab-img" ></image>
								     <image :src=" item.src" v-if ="tabCurrentIndex != index" mode="aspectFit" class="tab-img" ></image>
								 	<text >{{item.text}}</text>								 
