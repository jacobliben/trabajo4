<template>
	<view>
		<view class="title">《邮件快件包装管理办法》解读</view>
		<view class="body">
			<view class="sub-body">
				2021年2月8日，《邮件快件包装管理办法》发布，自2021年3月12日起施行。为便于各级邮政管理部门、有关企业、从业人员和广大用户更好地理解相关内容，切实做好该规章的贯彻实施工作，现解读如下：
			</view>
			 <view class="sub-title">一、制定背景</view>
			 <view class="sub-body">
			 ...
			 <view class="sub-title">二、制定过程</view>
			 <view class="sub-body">
			 ...
			 <view class="sub-title">三、主要内容</view>
			 <view class="sub-body">
