<template>
	<view class="vehicle-has-approved-body">
	  <view class="cu-bar bg-white search fixed" style="top:60px;" >
		...
		<label v-for="(item,index) in consignee_list" :key="item.value"  >
			<view class="one_vehicle">
				<view class="first-row">
					<image src="/static/user.svg" mode="widthFix" class="sm-icon" ></image>
					
					<view class="vehicle-no">{{item.consigneeName}}</view>
					<view>
						<image src="/static/phone.png" mode="widthFix" class="sm-icon" ></image>
						
						
						<text class="driverPhone" >{{item.consigneePhone}}</text>
					</view>
					<view>
						<text class="work_state">省份名称</text>
						
						<text class="vehicle_state" >{{item.consigneeProvinceName}}</text>
					</view>
				...
				<view class="first-row">
					...
					<view>
						...
						<text class="" >{{item.consigneeCityName}}</text>
					</view>
					<view>
						<text class="work_state">区县名称</text>
						
						<text class="" >{{item.consigneeRegionName}}</text>
					</view>
					...
					<view class="vehicle_content top-line-border">
						...
						<view class="right">
							<view class="work_state">收货地址</view>
								
							<view class="driverIdNumber" >{{item.consigneeAddress}}</view>		
						</view>
