<template>
	<view>
		<form @submit="formSubmit" >
				...
				<view class="cu-form-group" >
					<text class="title">更换手机号码<text class="red">*</text></text>
				...
				<view class="cu-form-group" >
					<text class="title">验证码<text class="red">*</text></text>
				...
				<view class="btn-row">
					...
					<button class="cu-btn bg-gradual-green round "  form-type="submit">确认提交</button> 
				</view>
		</form >
	</view>
</template>
