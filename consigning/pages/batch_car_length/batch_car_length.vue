	...
	export default {
		...
		methods: {
			...
			confirm(){
				...
				uni.setStorageSync("batch_cargo_box_type_chosen",this.cargoBoxTypeOptions)
				uni.setStorageSync("batch_cargo_box_label",this.cargoBoxTypeLabel)
				uni.setStorageSync("batch_vehicle_length_chosen",this.vehicleLengthOptions)
				uni.navigateTo({
